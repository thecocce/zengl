...
const
  SYS_FPS      = $0000001; // DWORD,  := zgl_Get( SYS_FPS )
  LOG_FILENAME = $0000002; // PPChar, := Pointer( zgl_Get( LOG_FILENAME ) )
...
var
  mouse_X          : function : WORD; stdcall;
  mouse_Y          : function : WORD; stdcall;
...
var
  ...
  snd_SetVolume    : procedure( Volume : Byte ); stdcall;
...
var
  smesh_LoadFromFile : function( FileName : String; var Mesh : zglPSMesh ) : Boolean; stdcall;
...
const
  VBO_USE_NORMALS   = $01;
  VBO_USE_TEXTURE   = $02;
  VBO_USE_MULTITEX1 = $04;
  VBO_USE_MULTITEX2 = $08;
  VBO_USE_MULTITEX3 = $10;
  VBO_CLEARDATA     = $20;

var
  vbo_Build : procedure( var IBuffer, VBuffer : DWORD; VCount, ICount : DWORD; Indices, Vertices, Normals, TexCoords, MultiTexCoords : Pointer; var Flags : DWORD ); stdcall;
  vbo_Free  : procedure( var IBuffer, VBuffer : DWORD; VCount, Icount : DWORD ); stdcall;
...
// LIGHT
  ...
  light_SetPosition : procedure( ID : Byte; X, Y, Z : Single ); stdcall;
...
// MATH
  ...
  matrix3f_RotateRad      : procedure( Matrix : zglPMatrix3f; aX, aY, aZ : Single );
  matrix3f_RotateDeg      : procedure( Matrix : zglPMatrix3f; aX, aY, aZ : Single );
  matrix3f_Add            : procedure( Matrix1, Matrix2 : zglPMatrix3f );
  matrix3f_Mul            : procedure( Matrix1, Matrix2 : zglPMatrix3f );
  // line 3d
...
type
  ...
  zglTCol3DCallback = procedure( Offset : zglPPoint3D );
...
var
  ...
  // plane 3d
  col3d_PlaneVsSphere : function( Plane : zglPPlane; Sphere : zglPSphere; Callback : zglTCol3DCallback ) : Boolean; stdcall;
  // aabb
  ...
  col3d_SphereVsNode   : function( Sphere : zglPSphere; Octree : zglPOctree; Node : zglPNode; Callback : zglTCol3DCallback ) : Boolean; stdcall;
...
begin
  ...
  if zglLib <> {$IFDEF LINUX} nil {$ENDIF} {$IFDEF WIN32} 0 {$ENDIF} Then
    ...
    //  octree_DrawDFaces := dlsym( zglLib, 'octree_DrawDFaces' );
      ...
      matrix3f_RotateRad := dlsym( zglLib, 'matrix3f_RotateRad' );
      matrix3f_RotateDeg := dlsym( zglLib, 'matrix3f_RotateDeg' );
